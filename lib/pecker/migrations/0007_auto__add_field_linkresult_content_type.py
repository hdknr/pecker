...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LinkResult.content_type'
        db.add_column(u'pecker_linkresult', 'content_type',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LinkResult.content_type'
        db.delete_column(u'pecker_linkresult', 'content_type')
