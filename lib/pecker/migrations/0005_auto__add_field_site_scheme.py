...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Site.scheme'
        db.add_column(u'pecker_site', 'scheme',
                      self.gf('django.db.models.fields.CharField')(default='https', max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Site.scheme'
        db.delete_column(u'pecker_site', 'scheme')
