========================================================================
** Pecker ** Installation Instructions
========================================================================

This section contains information about 
how to download and install **Pecker** in your system. 
...
To install **Pecker** from soruce code, use the provided installation script::
...
the `source code repository`_ using ``pip``::
    ...
    pip install -e git+https://github.com/hdknr/pekcer.git#egg=pekcer

The above command will install the latest development release of **Pecker**.
